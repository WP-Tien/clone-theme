...
function twentyseventeen_scripts()
{
	...
	wp_enqueue_style('bootstrap', get_theme_file_uri('assets/css/bootstrap.min.css'), array(), '1.0.0');
	wp_enqueue_style('font-awesome', get_theme_file_uri('assets/css/font-awesome.css'), array(), '1.0.0');
	wp_enqueue_style('owl-carousel', get_theme_file_uri('assets/css/owl-carousel.css'), array(), '1.0.0');
	wp_enqueue_style('tooplate-artxibition', get_theme_file_uri('assets/css/tooplate-artxibition.css'), array(), '1.0.0');
	// // Load the html5 shiv.
	...
	// }
	wp_enqueue_script('accordions', get_theme_file_uri('/assets/js/accordions.js'), ['jquery'], '1.0.0', true);
	wp_enqueue_script('bootstrap', get_theme_file_uri('/assets/js/bootstrap.min.js'), ['jquery'], '1.0.0', true);
	wp_enqueue_script('custom', get_theme_file_uri('/assets/js/custom.js'), ['jquery'], '1.0.0', true);
	wp_enqueue_script('imgfix', get_theme_file_uri('/assets/js/imgfix.min.js'), ['jquery'], '1.0.0', true);
	// wp_enqueue_script('jquery-2.1.0', get_theme_file_uri('/assets/js/jquery-2.1.0.min.js'), ['jquery'], '1.0.0', true);
	wp_enqueue_script('jquery.counterup', get_theme_file_uri('/assets/js/jquery.counterup.min.js'), ['jquery'], '1.0.0', true);
	wp_enqueue_script('mixitup', get_theme_file_uri('/assets/js/mixitup.js'), ['jquery'], '1.0.0', true);
	wp_enqueue_script('owl-carousel', get_theme_file_uri('/assets/js/owl-carousel.js'), ['jquery'], '1.0.0', true);
	wp_enqueue_script('popper', get_theme_file_uri('/assets/js/popper.js'), ['jquery'], '1.0.0', true);

	wp_enqueue_script('quantity', get_theme_file_uri('/assets/js/quantity.js'), ['jquery'], '1.0.0', true);
	wp_enqueue_script('scrollreveal', get_theme_file_uri('/assets/js/scrollreveal.min.js'), ['jquery'], '1.0.0', true);
	wp_enqueue_script('waypoints', get_theme_file_uri('/assets/js/waypoints.min.js'), ['jquery'], '1.0.0', true);
}
